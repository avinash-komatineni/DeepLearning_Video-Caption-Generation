...
model_path = 'SavedModel/model0.h5'
model = torch.load(model_path, map_location=lambda storage, loc: storage)
test_data_path = '/Users/avinashkomatineni/Desktop/deeplearning_hw2/testing_data/feat'
test_dataset = test_data('{}'.format(sys.argv[1]))
...
model = model.cuda()
predicted_captions = test(test_dataloader, model, i2w)
output_path = sys.argv[2]
with open(output_path, 'w') as f:
    for id, caption in predicted_captions:
        f.write('{},{}\n'.format(id, caption))
test_annotations = json.load(open('/Users/avinashkomatineni/Desktop/deeplearning_hw2/testing_label.json'))
predicted_captions = {}
